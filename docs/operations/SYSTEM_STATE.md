...
- Current queue mode: validation-decomposition slice 13 is now complete; the mandatory reassessment checkpoint is active before slice 14, and no continuation is authorized beyond slice 13 yet.
...
- Observation-center head item: `validation-slice-14-manual-checkpoint`
...
- Validation-decomposition progress note:
  ...
  - the next mandatory reassessment checkpoint is now active before slice `14/14`; no continuation is pre-approved beyond slice `13/14`
